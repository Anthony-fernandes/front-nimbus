...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  {
    ...
    permissions: [
      ...
      permissionOption("tickets.viewOwn", "Ver chamados proprios", "Consulta chamados criados pelo proprio usuario."),
      permissionOption("tickets.viewAssigned", "Ver chamados atribuidos", "Consulta chamados atribuidos diretamente ao usuario."),
      permissionOption("tickets.viewTeam", "Ver chamados da equipe", "Consulta chamados do grupo tecnico do usuario."),
      permissionOption("tickets.viewOrganization", "Ver chamados da organizacao", "Consulta chamados da organizacao atendida."),
      ...
      permissionOption("tickets.editOwnBeforeStart", "Editar proprio chamado antes do inicio", "Permite ao cliente ajustar o proprio chamado antes do atendimento iniciar."),
      permissionOption("tickets.assign", "Atribuir chamados", "Define tecnico ou equipe responsavel."),
      ...
      permissionOption("tickets.commentOwn", "Comentar nos proprios chamados", "Permite ao cliente responder nos proprios chamados."),
      permissionOption("tickets.validateOwn", "Validar proprios chamados", "Permite aprovar ou devolver os proprios chamados em validacao."),
      permissionOption("tickets.validateOrganization", "Validar chamados da organizacao", "Permite validar chamados da organizacao atendida."),
      permissionOption("tickets.rateOwn", "Avaliar atendimento", "Permite avaliar chamados concluidos."),
  ...
  },
  {
    ...
    permissions: [
      ...
      permissionOption("activities.manage", "Gerenciar atividades", "Permite administrar backlog, kanban e responsaveis."),
  ...
  },
  {
    ...
    permissions: [
      ...
      permissionOption("clients.manage", "Gerenciar organizacoes", "Permite administrar relacionamento e dados da organizacao."),
  ...
  },
  {
    ...
    label: "Usuarios",
    permissions: [
      permissionOption("users.view", "Ver usuarios", "Consulta usuarios da plataforma."),
      permissionOption("users.create", "Criar usuarios", "Permite cadastrar usuarios."),
      permissionOption("users.edit", "Editar usuarios", "Permite editar usuarios."),
      permissionOption("users.manage", "Gerenciar usuarios", "Permite administrar acessos e perfis."),
      permissionOption("users.delete", "Excluir usuarios", "Permite remover usuarios."),
  ...
  },
  {
    ...
    label: "Relatorios",
    permissions: [
      permissionOption("reports.view", "Ver relatorios", "Consulta dashboards e relatorios."),
      permissionOption("reports.export", "Exportar relatorios", "Permite exportar relatorios."),
    ],
  },
  {
    key: "settings",
    label: "Configuracoes",
    permissions: [
      permissionOption("settings.view", "Ver configuracoes", "Consulta configuracoes do sistema."),
      permissionOption("settings.edit", "Editar configuracoes", "Altera configuracoes globais."),
    ],
  },
  {
    key: "categories",
  ...
  },
  {
    ...
    permissions: [
      permissionOption("permissionBlocks.view", "Ver blocos de permissoes", "Consulta blocos reutilizaveis de permissoes."),
      ...
      permissionOption("permissionBlocks.manage", "Gerenciar blocos de permissoes", "Permite administrar blocos e aplicacao."),
...
export const PERMISSION_PRESETS: PermissionPreset[] = [
  ...
  },
  {
    key: "technician",
    label: "Tecnico",
    description: "Portal interno operacional com acesso controlado por permissoes.",
    role: "TECHNICIAN",
  },
  {
    key: "client",
