...
export interface ForumTopic { id: string; category: string; category_name?: string; title: string; content: string; tags: string[]; author: string; author_name?: string; is_pinned: boolean; is_locked: boolean; views_count: number; replies_count: number; likes_count: number; best_answer: string | null; converted_ticket?: string | null; visibility?: 'interna' | 'publica_cliente' | 'todos'; created_at: string; updated_at?: string; }
...
export interface ChatConversation { id: string; tipo?: 'direto' | 'grupo' | 'suporte' | 'chamado' | 'projeto' | 'entidade' | string; name?: string; participants: string[]; participant_names?: string[]; created_by: string; created_by_name?: string; last_message_at: string | null; ticket?: string | null; ticket_code?: string; ticket_title?: string; project?: string | null; client?: string | null; client_name?: string; created_at: string; is_archived?: boolean; unread_count?: number; status?: 'aberta' | 'aguardando_atendente' | 'em_atendimento' | 'aguardando_cliente' | 'encerrada' | string; assigned_to?: string | null; assigned_to_name?: string; last_message_preview?: string; }
