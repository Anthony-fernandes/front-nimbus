...
export const DASHBOARD_COMPONENT_TEMPLATES: DashboardComponentTemplate[] = [
  {
    type: "kpi",
    label: "Card / KPI",
    description: "Mostra um número principal com contexto rápido.",
    icon: "gauge",
  ...
  },
  {
    ...
    description: "Compara volumes por categoria ou responsável.",
    icon: "bar-chart-3",
    defaultDataSource: "tickets_by_owner",
    defaultTitle: "Comparativo",
    defaultSubtitle: "Distribuição por categoria",
    defaultColSpan: 6,
    defaultHeight: 330,
  },
  {
  ...
  },
  {
    ...
    description: "Resume percentual consumido ou concluído.",
    icon: "progress",
  ...
  {
    type: "text",
    label: "Bloco de texto / título",
    description: "Insere títulos, descricoes ou contexto narrativo.",
    icon: "type",
    defaultDataSource: "tickets_open",
    defaultTitle: "Texto",
...
export const DASHBOARD_SOURCE_CATALOG: DashboardSourceCatalogItem[] = [
  ...
  },
  {
    ...
    description: "Chamados que ja estao em execução.",
    category: "tickets",
    defaultComponentType: "kpi",
    supportedTypes: ["kpi", "list"],
  ...
  },
  {
    ...
    description: "Chamados ainda não assumidos.",
    category: "tickets",
    defaultComponentType: "kpi",
    supportedTypes: ["kpi", "list"],
    defaultTitle: "Sem responsável",
  ...
  },
  {
    ...
    defaultTitle: "Chamados por responsável",
  ...
  },
  {
    ...
    description: "Itens concluídos na sprint atual.",
    category: "sprint",
    defaultComponentType: "kpi",
    supportedTypes: ["kpi"],
    defaultTitle: "Concluídos",
  ...
  },
  {
    ...
    description: "Itens em execução na sprint.",
    category: "sprint",
    defaultComponentType: "kpi",
    supportedTypes: ["kpi", "table"],
    defaultTitle: "Em andamento",
    defaultSubtitle: "Execução atual",
    icon: "activity",
    tone: "primary",
  },
  {
    ...
    description: "Itens que ainda não comecaram na sprint.",
    category: "sprint",
    defaultComponentType: "kpi",
    supportedTypes: ["kpi", "table"],
    defaultTitle: "Não iniciados",
  ...
  },
  {
    ...
    description: "Percentual de itens concluídos.",
    category: "sprint",
  ...
  },
  {
    ...
    description: "Distribuição de status do ciclo.",
    category: "sprint",
    defaultComponentType: "donut",
    supportedTypes: ["donut", "bar", "table", "funnel"],
  ...
  },
  {
    ...
    label: "Distribuição por responsável",
    description: "Quantidade de itens por responsável.",
    category: "sprint",
    defaultComponentType: "bar",
    supportedTypes: ["bar", "table", "list"],
    defaultTitle: "Distribuição por responsável",
  ...
  },
  {
    ...
    description: "Projetos não concluídos.",
    category: "projects",
    defaultComponentType: "kpi",
    supportedTypes: ["kpi", "table"],
  ...
  },
  {
    ...
    description: "Distribuição do portifolio por status.",
    category: "projects",
    defaultComponentType: "bar",
    supportedTypes: ["bar", "donut", "table"],
  ...
  },
  {
    ...
    defaultSubtitle: "Compromissos próximos",
    icon: "calendar-days",
    tone: "accent",
  },
  {
    ...
    defaultSubtitle: "Distribuição do backlog",
    icon: "layers-3",
    tone: "primary",
  },
  {
    ...
    description: "Usuários internos ativos.",
    category: "users",
    defaultComponentType: "kpi",
    supportedTypes: ["kpi"],
    defaultTitle: "Pessoas ativas",
    defaultSubtitle: "Equipe disponível",
    icon: "users",
    tone: "success",
  },
  {
    ...
    label: "Capacidade por pessoa",
    description: "Horas de capacidade disponíveis por pessoa.",
    category: "users",
    defaultComponentType: "bar",
    supportedTypes: ["bar", "table"],
    defaultTitle: "Capacidade por pessoa",
...
export const DASHBOARD_FILTER_DEFINITIONS: DashboardFilterDefinition[] = [
  ...
  { id: "responsible", type: "responsible", label: "Responsável", field: "responsible", enabled: true },
...
export function createDefaultDashboard(userName = "Sistema"): DashboardDefinition {
  ...
  const rawComponents: DashboardComponentConfig[] = [
    ...
    createWidget({ type: "kpi", dataSource: "tickets_unassigned", title: "Sem responsável", layout: { order: 7, colSpan: 3, minHeight: 188 }, useGlobalFilters: false }, 7),
    ...
    createWidget({ type: "donut", dataSource: "tickets_by_status", title: "Status dos chamados", subtitle: "Distribuição atual", layout: { order: 10, colSpan: 5, minHeight: 330 }, useGlobalFilters: false }, 10),
    ...
    createSection(
      "Sprint selecionada",
      "Indicadores do ciclo respondendo aos filtros globais de sprint, equipe e responsável.",
      12,
    ),
    createWidget({ type: "kpi", dataSource: "sprint_items_total", title: "Itens da sprint", layout: { order: 13, colSpan: 3, minHeight: 188 } }, 13),
    createWidget({ type: "kpi", dataSource: "sprint_items_completed", title: "Concluídos", layout: { order: 14, colSpan: 3, minHeight: 188 } }, 14),
    createWidget({ type: "kpi", dataSource: "sprint_items_in_progress", title: "Em andamento", layout: { order: 15, colSpan: 3, minHeight: 188 } }, 15),
    createWidget({ type: "kpi", dataSource: "sprint_items_not_started", title: "Não iniciados", layout: { order: 16, colSpan: 3, minHeight: 188 } }, 16),
    ...
    createWidget({ type: "bar", dataSource: "sprint_owner_distribution", title: "Distribuição por responsável", layout: { order: 22, colSpan: 4, minHeight: 330 } }, 22),
